...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:header container class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700">
        ...
        <flux:brand href="#" logo="{{asset('images/logo/logo.jpg')}}" name="KialaCasa"
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item icon="document-text" href="#">Reserva</flux:navbar.item>
    ...
    <flux:sidebar stashable sticky
        ...
        <flux:brand href="#" logo="{{asset('images/logo/logo.jpg')}}" name="Kiala casa."
            class="px-2 dark:hidden" />
        <flux:brand href="#" logo="{{asset('images/logo/logo.jpg')}}" name="Kiala Casa."
            class="px-2 hidden dark:flex" />
        <flux:navlist variant="outline">
            <flux:navlist.item icon="home" href="#" current>Casa</flux:navlist.item>
            <flux:navlist.item icon="inbox" badge="12" href="#">mensagem</flux:navlist.item>
            <flux:navlist.item icon="document-text" href="#">Documentos</flux:navlist.item>
            <flux:navlist.item icon="calendar" href="#">Calendário</flux:navlist.item>
